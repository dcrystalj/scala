...
""")
    ...
    "test zero size" in {
      solution.pyramid(0) must have size(0)
    }
...
/* testing the uniq function */
  "The uniq function" should {
    ...
    "remove dups 3 char sequences" in {
      solution.uniq("cccaaaaaaabbbbbbbbbccc") mustEqual ("cabc")
    }
 ...
 "The isLycherel function" should {
    ...
    "return false if is not Lycherel" in {
      solution.isLycherel(349) mustEqual(false)
    }
